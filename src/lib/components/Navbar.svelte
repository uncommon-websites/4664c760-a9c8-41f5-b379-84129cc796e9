...
<div class="fixed top-0 left-0 w-full z-50 bg-background/80 backdrop-blur-md border-b border-white/5">
	...
	<div class="bg-background text-[11px] text-gray-400 py-2.5 text-center border-b border-white/5 tracking-wide">
		Backed by Blackstone & BCG expertise. <a href="#" class="text-white hover:text-gray-300 transition-colors inline-flex items-center gap-1 group">Learn about our team <ArrowRight size={10} class="group-hover:translate-x-0.5 transition-transform" /></a>
	</div>
